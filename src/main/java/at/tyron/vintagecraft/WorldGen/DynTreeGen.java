...
public class DynTreeGen {
	public static Block vineBlock = Blocks.vine; 
...
//				0.8f,
		...
		EnumTree.JUNGLE.setGenerators(new DynTreeGen(
				EnumTree.JUNGLE, 
				null,
				new DynTreeTrunk(
//					1.15f,
...
//					0.9f,
		...
		EnumTree.DARKOAK.setGenerators(new DynTreeGen(
				EnumTree.DARKOAK, 
				null,
				new DynTreeTrunk(
					1f, 
